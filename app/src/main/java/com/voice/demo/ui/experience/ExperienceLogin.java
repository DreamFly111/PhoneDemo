...
public class ExperienceLogin extends LoginUIActivity {
	...
	private void doLoginReuqest() {
		String userName = "13641194007@139.com";
		String userPass = "19800402";
	...
	private void initialize(Bundle savedInstanceState) {
		String userName = CcpPreferences.getSharedPreferences().getString(CCPPreferenceSettings.SETTING_USERNAME_MAIL.getId(), (String) CCPPreferenceSettings.SETTING_USERNAME_MAIL.getDefaultValue());
		String userPassword = CcpPreferences.getSharedPreferences().getString(CCPPreferenceSettings.SETTING_USER_PASSWORD.getId(), (String) CCPPreferenceSettings.SETTING_USER_PASSWORD.getDefaultValue());
